                ...
                SizedBox(
                  ...
                  child: Stack(clipBehavior: Clip.none, children: [
                    ...
                    Positioned(
                      ...
                      left: 135,
                      child: Align(
                          alignment: Alignment.center, child: CircleBear()),
                    )
                  ]),
                ),
                SizedBox(
                    ...
                    child: BlocListener<LoginBloc, LoginState>(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          ...
                          // Navigator.push(context, MaterialPageRoute(builder: (context){ return getit.get<SharedPreferences>().getString("token")!=null?homepage():SignupView();} ));
                        },
                        child: Text(
                          'Login',
                          style:
                              TextStyle(color: Color(0xff0A324D), fontSize: 25),
                        ),
                      ),
                    ),
                  ),
